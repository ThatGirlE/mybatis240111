package com.djava.mybatis.controller;
...
import com.djava.mybatis.dao.MemberDao;
import com.djava.mybatis.dao.MybatisDao;
...
public class MybatisController {
	...
	@Autowired // 의존 자동 주입
	private SqlSession sqlSession; // 그릇만드는것, servlet-context.xml  과 di
	
	@RequestMapping(value="/list")
	public String list(Model model) {
		
		//MybatisDao dao = new MybatisDao() {    // 못만듬 interface.
	...
	public String search(HttpServletRequest request, Model model) {
		...
		ArrayList<MybatisDto> dtos = dao.searchDao(request.getParameter("searchKey"));
